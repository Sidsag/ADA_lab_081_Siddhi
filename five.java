...
// Making the matrices bigger so that you can apply the strassen
...
//for(int i=0;i<c.length;i++){
   ...
   // System.out.println("");
//}
System.out.println("coventional method time for " +n+" size : "+durationC);
System.out.println("Strassen's method time for " +n+" size : "+durationS);
}
}